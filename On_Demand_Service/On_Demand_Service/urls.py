...
urlpatterns = [
    ...
    path('',auth_views.LoginView.as_view( template_name = 'Login_Page.html' ),name='login'),
     path('logout/', home.views.logoutUser,name='logout'),
    path('change-password/',auth_views.PasswordChangeView.as_view( template_name = 'forgot_password.html' )),
    path('password_change_done/',auth_views.PasswordChangeDoneView.as_view( template_name = 'forgot_password_done.html' ),name='password_change_done'),
